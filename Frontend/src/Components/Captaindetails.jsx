    ...
    <div> 
        ...
        <div className="bg-yellow-100 rounded-2xl p-4 flex justify-between items-start mb-4">
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <h2 className="text-lg font-bold text-gray-900">{captainData?.stats?.totalRides || 0}</h2>
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <h2 className="text-lg font-bold text-gray-900">{captainData?.stats?.totalDistance ? captainData.stats.totalDistance.toFixed(1) : '0'} km</h2>
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <h2 className="text-lg font-bold text-gray-900">₹{(captainData?.stats?.totalEarnings || 0).toLocaleString()}</h2>
